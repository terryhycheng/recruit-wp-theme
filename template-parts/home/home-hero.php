<section class="relative overflow-hidden text-white min-h-[45vh] flex justify-center flex-col">
  <div class="max-w-[1500px] w-full mx-auto px-4 flex flex-col items-center lg:items-start text-center lg:text-left">
    ...
    <a href="/jobs" class="w-full max-w-[250px] px-6 py-2 capitalize border border-white flex justify-between items-center mt-10 hover:bg-white hover:text-main transition-all duration-300">
